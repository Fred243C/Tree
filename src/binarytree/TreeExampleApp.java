...
public class TreeExampleApp{
    public static void main(String[] args){
		...
		*/
        ...
        System.out.println("preOrderTraversal of binary tree is: ");
        bst.preOrderTraversal(bst.theRoot);
        
        System.out.println("postOrderTraversal of binary tree is: ");
        bst.postOrderTraversal(bst.theRoot);
        
        System.out.println("countNodes of binary tree is"+ bst.countNodes(bst.theRoot));
