...
//in-order traversal is used to parse and print all the nodes of the tree
  ...
  public void preOrderTraversal(BTNode theStart){
      ...
      if(theStart==null)
          return;
      System.out.println(theStart.getElement());
  ...
  public int countNodes(BTNode theStart){
      ...
      int left= countNodes(theStart.getLeft());
      int right= countNodes(theStart.getRight());
      System.out.println(theStart.getElement());
        return left+right+1 ;
 ...
 //determines the height of a tree
  ...
  public int height (BTNode theStartNode){
      ...
      if(theStartNode==null)
          ...
          int leftH = height(theStartNode.getLeft());
          int rightH= height(theStartNode.getRight());
